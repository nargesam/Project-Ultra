...
class decipherEnigmaMachine():
    ...
    def on_hot_vectors(self):
        ...
        # dictionary of unique chars to  index 
        ...
        # dictionary of unique index  to chars
        self.dict_int_char_plain = {index:char for index, char in enumerate(self.chars_plain)}
        self.dict_int_char_cipher = {index:char for index, char in enumerate(self.chars_cipher)}
    ...
    def train(self):
        ...
        self.model.fit(x=[self.one_hot_plain, self.one_hot_cipher], y=self.target_one_hot, \
                    batch_size=10, epochs=3, validation_split=0.3)
    ...
    def test(self):
        ...
        print(seq, decipher_sent)



if __name__ == "__main__":
    plain, cipher = generate_data(1<<8)
    train_plain  = plain
    train_cipher = cipher
